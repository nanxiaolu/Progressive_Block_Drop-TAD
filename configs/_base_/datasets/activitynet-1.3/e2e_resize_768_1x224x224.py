...
subtest_annotation_path = "data/activitynet-1.3/annotations/activity_net.v1-3.min_subtest_anno.json"
class_map = "data/activitynet-1.3/annotations/category_idx.txt"
data_path = "data/activitynet-1.3/raw_data/Anet_videos_15fps_short256" # change to your own path
block_list = None
...
dataset = dict(
    ...
    sub_test=dict(
        type=dataset_type,
        ann_file=subtest_annotation_path,
        subset_name="validation",
        block_list=block_list,
        class_map=class_map,
        data_path=data_path,
...
sub_evaluation = dict(
    ...
    subset="validation",
    tiou_thresholds=[0.5, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95],
    ground_truth_filename=subtest_annotation_path,
    blocked_videos="data/activitynet-1.3/annotations/blocked.json",
)
