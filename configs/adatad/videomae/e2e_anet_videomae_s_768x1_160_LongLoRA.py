...
model = dict(
    backbone=dict(
        ...
        custom=dict(
            pretrain=".pretrain/vit-small-p16_videomae-k400-pre_16x4x1_kinetics-400_my.pth", # you need to change it to your own path
...
work_dir = f"exps/anet/adatad/baseline_768x1_160_LongLoRA"
