...
model = dict(
    backbone=dict(
        ...
        backbone=dict(
            type="VisionTransformerDropBlock",
            img_size=224,
            patch_size=16,
            embed_dims=384,
            depth=12,
...
# work_dir = f"exps/thumos/adatad/e2e_actionformer_videomae_s_768x1_160_fullft_drop_block/twice_{model['backbone']['backbone']['drop_idx']}"
