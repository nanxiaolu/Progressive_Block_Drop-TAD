...
class BackboneWrapper(nn.Module):
    ...
    def forward(self, frames, masks=None, **kwargs):
        ...
        if self.freeze_backbone:  # freeze everything even in training
            ...
            if self.use_temporal_checkpointing:
                ...
                features = self.model.backbone(frames, **kwargs)

        if 'is_teacher' in kwargs and kwargs['is_teacher']:
            features, feat_mid_list, feat_out_list = features
        elif 'is_student' in kwargs and kwargs['is_student']:
            features, loss_backbone = features
        ...
        if 'is_teacher' in kwargs and kwargs['is_teacher']:
            return features, feat_mid_list, feat_out_list
        elif 'is_student' in kwargs and kwargs['is_student']:
            return features, loss_backbone
