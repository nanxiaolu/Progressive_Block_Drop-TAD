...
class VisionTransformerLongLoRADropBlockStep(BaseModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #     if "lora" not in name:
        #         num_vit_param += p.numel()
        #     if "lora" in name and "blocks.1." not in name and "blocks.2." not in name and "blocks.3." not in name:
        #         num_lora_param += p.numel()
    ...
    # def set_factor(self, epoch, max_epoch) -> None: # the weight of block output
