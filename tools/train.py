...
def main():
    ...
    if args.local_rank == 0:
        if os.path.isdir(cfg.work_dir):
            ...
            #     print('Dir removed: ', cfg.work_dir)
            # else:
            #     print('Dir not removed: ', cfg.work_dir)
    ...
    if 'ckpt_path' in cfg.model.backbone.custom.keys():
        ckpt_path = cfg.model.backbone.custom['ckpt_path']
    ...
    for epoch in range(resume_epoch + 1, max_epoch):
        ...
        #     model.module.backbone.model.backbone.set_factor(epoch, max_epoch)
