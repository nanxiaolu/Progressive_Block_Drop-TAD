...
model = dict(
    backbone=dict(
        ...
        backbone=dict(
            type="VisionTransformerLongLoRAReLU",
            img_size=224,
            patch_size=16,
            embed_dims=384,
            depth=12,
        ...
        custom=dict(
            pretrain="/mnt/data/chenxiaoyong/tad_accelerate/pretrain/vit-small-p16_videomae-k400-pre_16x4x1_kinetics-400_my.pth",
...
work_dir = f"exps/thumos/adatad/e2e_actionformer_videomae_s_768x1_160_Longlora_relu/{custom_lr}"
