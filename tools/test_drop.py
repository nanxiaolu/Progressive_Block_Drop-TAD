...
from opentad.cores import eval_one_epoch, eval_drop_one_block
from opentad.utils import update_workdir, set_seed, create_folder, setup_logger, search_drop_idx
...
def main():
    ...
    # setup logger
    logger = setup_logger("Test", save_dir=cfg.work_dir, distributed_rank=args.rank, filename="test_log.txt")
