...
def save_test_checkpoint(model, model_ema, optimizer, scheduler, epoch, work_dir=None):
    save_dir = os.path.join(work_dir, "checkpoint")
...
def save_val_checkpoint(model, model_ema, optimizer, scheduler, epoch, work_dir=None):
    save_dir = os.path.join(work_dir, "checkpoint")
    ...
    checkpoint_path = os.path.join(save_dir, "val_best.pth")
    torch.save(save_states, checkpoint_path)