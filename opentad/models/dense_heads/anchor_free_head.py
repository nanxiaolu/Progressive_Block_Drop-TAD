...
class AnchorFreeHead(nn.Module):
    ...
    def forward_train(self, feat_list, mask_list, gt_segments, gt_labels, **kwargs):
        ...
        return self.losses(cls_pred, reg_pred, mask_list, points, gt_segments, gt_labels, **kwargs)
    ...
    def losses(self, cls_pred, reg_pred, mask_list, points, gt_segments, gt_labels, **kwargs):
        ...
        if 'is_teacher' in kwargs and kwargs['is_teacher']:
            return cls_pred, pred_segments
        elif 'is_student' in kwargs and kwargs['is_student']:
            return {"cls_loss": cls_loss, "reg_loss": reg_loss * loss_weight}, cls_pred, pred_segments, gt_target
