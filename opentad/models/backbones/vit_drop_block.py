...
class VisionTransformerDropBlock(BaseModule):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #     if "blocks.1." not in name:
        #         num_ft_param += p.numel()
        # ratio = num_ft_param / num_vit_param * 100
        # print("ViT's param: {}, LoRA's params: {}, ratio: {:2.1f}%".format(num_vit_param, num_ft_param, ratio))
