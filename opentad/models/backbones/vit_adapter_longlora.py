...
class VisionTransformerAdapterLongLoRA(BaseModule):
    ...
    Args:
        ...
        random_drop_idx (list): The index of skipping block.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ratio = (num_adapter_param + num_lora_param) / num_vit_param * 100
        print("ViT's param: {}, LoRA + Adapter's params: {}, ratio: {:2.1f}%".format(num_vit_param, num_adapter_param, ratio))
    ...
    def _freeze_layers(self):
        ...
        for name, param in self.blocks.named_parameters():
            if "lora" not in name and "norm" not in name and "adapter" not in name:
